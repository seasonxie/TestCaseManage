...
public class Test1 {
	...
	@Autowired
	private CaseServiceI initService;
	...
	@Test
	public void test() {
		MockUtil.MockStart=true;
		/* MockitoAnnotations.initMocks(BugDaoI.class);  */
		
		 //bugService=(BugServiceI) ac.getBean("bugServiceImpl");
		//ac.getBean("sy.service");
		/*List<Object> aaa=new LinkedList<Object>();
		aaa.add("asd");
		Map<String,List<Object>> aa=new HashMap<String,List<Object>>();
	    aa.put("aa", aaa);
		 when(bugService.clo()).thenReturn(aa);  */
		System.out.println(bugService.clo());
		MockUtil.MockStart=false;
