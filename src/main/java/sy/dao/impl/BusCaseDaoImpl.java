...
@Repository
public class BusCaseDaoImpl extends BaseDaoImpl<Tbuscase> implements BusCaseDaoI {
	...
	public List<Tbuscase> findBySqll(String date) throws Exception {	
			String queryString = "from TTask as model where model.progress !='已完成' and model.tester='"+date+"'";
			return  ((BaseDaoI<Tbuscase>) getCurrentSession()).find(queryString);
	}
}
