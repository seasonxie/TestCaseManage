...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/dataController/add',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
     ...
     <tr>     
     <th>数据名字</th>
					<td><input name="name" id="name" type="text" placeholder="请输入名字"  data-options="required:true" class="easyui-validatebox span2" style="width:100px;" value=""></td>   
     ...
     <tr>        
            <th>边界值</th>  
            <td><input type="text" name="boundary_down"  data-options="required:true" style="width:60px;" class="easyui-validatebox span2"/></td>  
            <th>到</th>  
            <td><input type="text" name="boundary_up"   data-options="required:true" style="width:60px;" class="easyui-validatebox span2"/></td>  
        </tr>  
        <tr>  
            <th>前置空格:</th>  
            <td><input type="checkbox" name="blank_q" id="blank_q"/></td>  
